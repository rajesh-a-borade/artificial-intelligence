...
# Description - Generating music using neural networks
# Code is heavily based on the work of https://github.com/jiexunsee/rudimentary-ai-composer
...
mid = MidiFile('./data/midi_files/jhalak_dikhla_ja.mid') # a Mozart piece
...
model.fit(np.array(X), np.array(Y), batch_size=300, epochs=5, verbose=1)
...
mid.save('./data/midi_output/ai_himesh.mid')